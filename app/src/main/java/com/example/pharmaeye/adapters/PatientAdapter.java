...
import com.example.pharmaeye.listeners.OnRowClicked;
...
public class PatientAdapter extends RecyclerView.Adapter<PatientAdapter.PatientViewHolder> {
    ...
    public PatientAdapter(Context context, ArrayList<Patient> patients, OnRowClicked clickListener){
    ...
    public static class PatientViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bind(Context context, Patient currPatient, OnRowClicked clickListener){
            itemBinding.tvLine1.setText(currPatient.getName());
            itemBinding.tvLine2.setText("Patient ID: " + currPatient.getId());
            ...
            itemBinding.getRoot().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    clickListener.onRowClicked(currPatient);
                }
            });
        }
    }
